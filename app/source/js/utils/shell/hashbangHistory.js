/**
    ...
    - This class must be instantiated early because must be the first attaching a handler for native 'popstate',
      so can block all others and avoid edge-case errors.
    - replaceState will not replace the current URL in the history list on browsers where it is not supported natively
**/
//global location
'use strict';
var $ = require('jquery'),
    ...
    Modernizr = require('custom-modernizr');
