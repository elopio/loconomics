...
module.exports = {
    ...
    'prototypeHouseCleanerServiceEditor': require('./activities/prototypeHouseCleanerServiceEditor'),
    'prototypeDogWalkerServiceEditor': require('./activities/prototypeDogWalkerServiceEditor'),
    'prototypeBabySitterServiceEditor': require('./activities/prototypeBabySitterServiceEditor'),
    'prototypeRateEditor': require('./activities/prototypeRateEditor'),
    'prototypeServiceConsultationEditor': require('./activities/prototypeServiceConsultationEditor'),
    'prototypeServiceEditor': require('./activities/prototypeServiceEditor'),
    'prototypePackageEditor': require('./activities/prototypePackageEditor'),
    'prototypePackageMultiClientServiceEditor': require('./activities/prototypePackageMultiClientServiceEditor'),
    'prototypeRollingMultiClientServiceEditor': require('./activities/prototypeRollingMultiClientServiceEditor'),
    'prototypeContractServiceEditor': require('./activities/prototypeContractServiceEditor'),
    'prototypePetSitterServiceEditor': require('./activities/prototypePetSitterServiceEditor'),
    'prototypeHouseSitterServiceEditor': require('./activities/prototypeHouseSitterServiceEditor'),
