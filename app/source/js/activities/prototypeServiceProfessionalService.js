...
var A = Activity.extend(function PrototypeServiceProfessionalServiceActivity() {
    ...
    this.registerHandler({
        ...
        handler: function(jobTitleID) {
            if (jobTitleID) {
                ...
                var found = /prototypeServiceProfessionalService\/(\d+)/i.exec(window.location);
                var urlID = found && found[1] |0;
                if (urlID !== jobTitleID) {
                    var url = '/prototypeServiceProfessionalService/' + jobTitleID;
...
A.prototype.show = function show(options) {
    ...
    if (isAdditionMode) {
        ...
        this.viewModel.cancelLink('/prototypeServiceProfessionalService/' + jobTitleID);
    }
...
function ViewModel(app) {
    ...
    this.jobTitles.baseUrl('/prototypeServiceProfessionalService');
